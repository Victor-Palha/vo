...
config :vo, VoWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: VoWeb.ErrorHTML, json: VoWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Vo.PubSub,
  live_view: [signing_salt: "bmDMGiET"]
...
config :vo, Vo.Mailer, adapter: Swoosh.Adapters.Local
